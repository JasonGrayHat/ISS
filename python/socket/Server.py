#!/usr/bin/env python3
"""
Submitted by :Jaesung, Lee
Date : Dec 15th, 2019
File : ServerBackend.py
Scope:
This is the server part of the Echo application.
(1)It will receive text from the client,
(2)change it to all uppercase,
(3)then send it back.
(4)Server keeps text file log between runtimes.
"""
import socket
import logging
